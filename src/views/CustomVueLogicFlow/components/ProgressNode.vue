            ...
            <div class="itemForm">
              <el-row :gutter="20">
                <el-col :span="8" style="margin-bottom: 10px">
                  <el-input v-model="item.fieldName" placeholder="请输入字段名" /></el-col>
                <el-col :span="8" style="margin-bottom: 10px">
                ...
                <el-col :span="8" style="margin-bottom: 10px"
                  v-if="item.fieldType?.slice(-1) == 1 || item.fieldType?.slice(-1) == 2">
                  <el-input v-model="item.fieldAccuracy" placeholder="请输入精度" /></el-col>
                <el-col :span="8" style="margin-bottom: 10px" v-if="item.fieldType?.slice(-1) == 2">
                  <el-input v-model="item.scale" placeholder="请输入标度" /></el-col>
              </el-row>
            </div>
          </div>
        </div>
